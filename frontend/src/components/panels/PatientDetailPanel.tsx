...
export function PatientDetailPanel({
  ...
  // Le contenu reste visible pendant le slide-out — effacé sur transition end.
  const [displayedPatient, setDisplayedPatient] = useState<Patient | null>(
    null,
  );
...
function PanelBody({
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 space-y-4">
      <div>
        <div className="text-xl font-bold text-gray-900">{patient.nom}</div>
        <div className="mt-1">
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          ...
          <select
            ...
            onChange={(e) =>
              onChangeStatus(patient.id, e.target.value as PatientStatus)
            }
